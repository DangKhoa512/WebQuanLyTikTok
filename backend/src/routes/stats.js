...
router.get('/instagram-job/daily', ctrl.getInstagramJobDailyStats);
router.get('/instagram-job/devices', ctrl.getInstagramJobDeviceStats);
router.get('/instagram-job', ctrl.getInstagramJobStats);

...
const FacebookNurtureLog = sequelize.define('FacebookNurtureLog', {
  ...
  status: {
    type: DataTypes.ENUM('DA_NUOI', 'NUOI_FAIL'),
    allowNull: false,
  },
  ...
  tableName: 'facebook_nurture_logs',
  timestamps: true,
  createdAt: 'created_at',
  updatedAt: 'updated_at',
  indexes: [
    { name: 'idx_fb_nurture_logs_owner_created', fields: ['owner_username', 'created_at'] },
    { name: 'idx_fb_nurture_logs_account', fields: ['facebook_account_id', 'created_at'] },
    { name: 'idx_fb_nurture_logs_device', fields: ['owner_username', 'device_id', 'created_at'] },
    { unique: true, name: 'uq_fb_nurture_logs_owner_run', fields: ['owner_username', 'run_id'] },
  ],
});

module.exports = FacebookNurtureLog;